...
namespace CedrosNahuizalquenos.Controllers
{
    public class InventariosController : Controller
    {
        ...
        public InventariosController(CedrosNahuiContext context)
        {
            _context = context;
        }
        ...
        {
            var cedrosNahuiContext = _context.Inventarios.Include(i => i.Producto);
        ...
        public async Task<IActionResult> Create([Bind("InventarioId,ProductoId,CantidadStock,FechaActualizacion")] Inventario inventario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InventarioId,ProductoId,CantidadStock,FechaActualizacion")] Inventario inventario)
        {
